<?php  
class ControllerCommonKulerContentBottom extends Controller {
	protected function index() {
		...
		if ($route == 'module/kbm/category' && isset($this->request->get['path']))
		{
		...
		if ($route == 'module/kbm/article' && isset($this->request->get['article_id']))
		{
			$layout_id = $this->model_module_kbm->getArticleLayoutId($this->request->get['article_id']);
		}
