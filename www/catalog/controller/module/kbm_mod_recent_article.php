...
class ControllerModuleKBMModRecentArticle extends Controller
{
    ...
    public function index($setting)
    {
        ...
        {
            $this->template = $this->config->get('config_template') . '/template/module/kbm_mod_recent_article.tpl';
        }
        else
        {
            $this->template = 'default/template/module/kbm_mod_recent_article.tpl';
        }
