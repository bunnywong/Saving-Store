<?php
class ControllerCheckoutXShippingAddress extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/xshipping_address.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/xshipping_address.tpl';
		} else {
			$this->template = 'default/template/checkout/xshipping_address.tpl';
		}
	...
	public function validate() {
		...
		if (!$json) {
			if (isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'existing') {
				...
				} elseif (!in_array($this->request->post['saddress_id'], array_keys($this->model_account_xaddress->getAddresses()))) {
					$json['error']['warning'] = $this->language->get('error_address');
				}
