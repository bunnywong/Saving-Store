			...
			<div class="cart-info">
				<table class="list">
					...
					<tbody>
						...
						<tr>
							<td colspan="6" style="border:none;"><image src="catalog/view/theme/egestas-pro/image/reorder.png" alt="" title="" style="float:left;" />
						...
						<tr>
							...
							<td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
								&nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/arcu-pro/image/icons/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
