...
<table class="xten" width="100%">
  ...
  <?php if ($address['address_id'] == $address_id) { ?>
  	<td>
  		<input id="p-<?php echo $address['address_id']; ?>" type="radio" name="paddress_id" value="<?php echo $address['address_id']; ?>" checked="checked"/>
  ...
  <?php }else{?>
  	<td>
  		<input id="p-<?php echo $address['address_id']; ?>" type="radio" name="paddress_id" value="<?php echo $address['address_id']; ?>" />
  		<label for="p-<?php echo $address['address_id']; ?>">
  			<?php echo $address['address']; ?>
  		</label>
  	</td>
...
<?php } ?>
<div class="xleft" id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  ...
  <?php } else { ?>
    ...
    <tr sort="a<?php echo $modData['companyId_sort']; ?>">
      ...
      <td><input type="text" <?php if($title_company_id) echo "title ='".$title_company_id."'";?> name="company_id" value="" class="large-field <?php echo ($modData['companyId_numeric']?"numeric":""); ?>" /></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
    <?php if ($company_id_display) { ?>
