<div class="left">
 ...
 <div class="xpersonal1">
  ...
  <?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['mob_show_checkout']) { ?>
  <xdiv sort="a<?php echo $modData['mob_sort']; ?>" >
  <?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['mob_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_telephone; ?><br />
  ...
  <?php } ?>
  <?php if(!$isActive['enablemod'] || $isActive['enablemod'] && $modData['fax_show_checkout']){ ?>
...
<div class="right">
 ...
 <?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['company_show_checkout']) { ?>
 <xdiv sort="a<?php echo $modData['company_sort']; ?>" >   
  ...
  <?php if(!$isActive['enablemod'] || $isActive['enablemod'] && $modData['companyId_show_checkout']){ ?>
...
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['address1_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_address_1; ?><br />
<input type="text" <?php if($title_address_1) echo "xtitle ='".$title_address_1."'";?> name="address_1" value="" class="large-field" />
<br />
<br />
</xdiv>
<?php }else{ ?>
  <input type="hidden" name="address_1" value="<?php echo $address_1; ?>" class="large-field" />
  <?php } ?>  
<?php if(!$isActive['enablemod'] || $isActive['enablemod'] && $modData['address2_show_checkout']){ ?>
...
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['city_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_city; ?><br />
<input type="text" <?php if($title_city) echo "xtitle ='".$title_city."'";?> name="city" value="" class="large-field" />
<br />
<br />
</xdiv>
<?php }else{ ?>
  <input type="hidden" name="city" value="<?php echo $city; ?>" class="large-field" />
  <?php } ?>  
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['pin_show_checkout']) { ?>
<xdiv sort="a<?php echo $modData['pin_sort']; ?>" >   
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['pin_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_postcode; ?><br />
...
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['country_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_country; ?><br />
...
<?php if (!$isActive['enablemod'] || $isActive['enablemod'] && $modData['state_req_checkout'])  echo "<span class = required >*</span>" ; ?> <?php echo $entry_zone; ?><br />
...
//--></script> 
<script type="text/javascript"><!--
$('#payment-address <?php ((!$isActive['enablemod'] || $isActive['enablemod'] && $modData['country_show_checkout'])?'select':'input');?>[name=\'country_id\']').bind('change', function() {
...
$('#payment-address <?php ((!$isActive['enablemod'] || $isActive['enablemod'] && $modData['country_show_checkout'])?'select':'input');?>[name=\'country_id\']').trigger('change');
//--></script>
