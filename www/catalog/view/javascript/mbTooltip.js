...
(function($){
  jQuery.fn.mbTooltip = function (options){
    return this.each (function () {
      ...
      if (this.options.live)$("[xtitle]").live("mouseover",function(){$(this).mbTooltip(options);});
      var ttEl=$(this).is("[xtitle]")? $(this): $(this).find("[xtitle]");
...
*/
        $(this).attr("tooltip", $(this).attr("xtitle"));
        $(this).removeAttr("xtitle");
  ...
  $(function(){
    ...
    $("select[xtitle]").each(function(){
      var selectSpan=$("<span></span>");
      selectSpan.attr("xtitle",$(this).attr("xtitle"));
