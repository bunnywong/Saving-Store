	...
	$.fn.pavoSliderEditor = function( initvar ) {
		...
		this.preview=function(){
				...
				var $class = $("#"+field).val();
					...
					$('#container').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><form action="'+$this.adminURL+'&route=module/kuler_layer_slider/preview&field='
						+ encodeURIComponent(field) + '" method="post" target="iframename" id="formid"><input type="Hidden" name="slider_preview_data" id="slider-preview-data"></form><iframe name="iframename" src="'+$this.adminURL+'&route=module/kuler_layer_slider/preview&field='
		...
		this.insertTypo=function(){
 			...
 			$("#btn-insert-typo").click( function(){ 
				...
				var $class = $("#"+field).val();
					...
					$('#container').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="'+$this.adminURL+'&route=module/kuler_layer_slider/typo&	field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
		...
		this.showDialogImage=function(  thumb ){
			...
			$('#dialog').remove();
			$('#container').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="'+$url+'&route=common/filemanager&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
			$('#dialog').dialog({
