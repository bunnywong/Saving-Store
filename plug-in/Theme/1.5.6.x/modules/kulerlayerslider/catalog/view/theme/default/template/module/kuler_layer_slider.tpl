...
<?php } ?>
			<div class="bannercontainer banner-<?php echo trim($class);?>" style="padding: <?php echo $sliderParams['padding'];?>;margin: <?php echo $sliderParams['margin'];?>;<?php if ($sliderParams['background_color']) echo ' background-color: ' . $sliderParams['background_color']; ?>;<?php if ($sliderParams['background_image'] && $sliderParams['background_url']) echo ' background-image: url(' . $sliderParams['background_url'] . ')'; ?>;">
